    ...
    <div>
      ...
      <div className="container">
        <p className="first-slide">
          <span>
            PASSION️‍️‍🔥, CREATIVITY🎨, NOBLE🛡️, WISE💡, FINANCE💵&nbsp;
          </span>
        </p>
      ...
      <div className="about-container">
        <div className="about-div about-header-div">
        ...
        <div className="about-div about-content">
          <div className="about-div-header">
            We believe in right choice. Wise spendings. Products like: Character
            skins, weapon skins, and games the like.
          </div>
          <br />
          <div className="about-div-header">What are we left with?</div>
          <div>
            Extra spending on objects that encourage additional spending or stop
            there, this helps both the game company and the customer on spending
            for the right thing and the right time.
          </div>
        </div>
      </div>
    </div>
